...
M14 follow-up, see docs/specs/M14-dog-disease-detection.md. `DISEASES` matches M14's
originally-researched disease list (canine distemper, canine parvovirus, kennel cough, mange).

**No "Healthy" class exists** — no healthy-dog photos were found in any dataset evaluated this
session. This model always names one of the 4 diseases below; it cannot say a dog is healthy.
Real, disclosed limitation — see docs/DISCLAIMER.md and data/dog-images/SOURCE.md.
...
DISEASES = ["Canine Distemper", "Canine Parvovirus", "Kennel Cough", "Mange"]
